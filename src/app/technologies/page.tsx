...
const InteractiveCard = ({ pillar, index }: { pillar: any, index: number }) => {
        ...
        <div className="container mx-auto px-4 max-w-[1400px]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
            <div className="lg:col-span-7">
              ...
              >
                "The best stack is the one your team can maintain at <span className="text-brand-blue">2am</span> when something breaks."
              </motion.h2>
            </div>
